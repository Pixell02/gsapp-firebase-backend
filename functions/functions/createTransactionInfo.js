...
exports.createTransactionInfo = functions.https.onRequest((req, res) => {
    ...
    const mailOptions = {
      ...
      subject: `${user.email} właśnie zaczął dokonywanie zakupu licencji`,
      text: `${user.email} właśnie zaczął dokonywanie zakupu licencji`
    };
    try {
      // Send the email
